...
type BroadcastClient interface {
	CreateStream(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (Broadcast_CreateStreamClient, error)
...
func (c *broadcastClient) CreateStream(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (Broadcast_CreateStreamClient, error) {
...
func (c *broadcastClient) DisconnectStream(ctx context.Context, in *DisconnectRequest, opts ...grpc.CallOption) (*Close, error) {
	out := new(Close)
	err := c.cc.Invoke(ctx, "/proto.Broadcast/DisconnectStream", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) Publish(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Close, error) {
	out := new(Close)
	err := c.cc.Invoke(ctx, "/proto.Broadcast/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BroadcastServer interface {
	CreateStream(*ConnectRequest, Broadcast_CreateStreamServer) error
...
func (UnimplementedBroadcastServer) CreateStream(*ConnectRequest, Broadcast_CreateStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateStream not implemented")
}
func (UnimplementedBroadcastServer) DisconnectStream(context.Context, *DisconnectRequest) (*Close, error) {
...
func (UnimplementedBroadcastServer) Publish(context.Context, *Message) (*Close, error) {
...
func _Broadcast_DisconnectStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Broadcast/DisconnectStream",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BroadcastServer).DisconnectStream(ctx, req.(*DisconnectRequest))
	}
...
func _Broadcast_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Broadcast/Publish",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
